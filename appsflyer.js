...
function _iterableToArrayLimit(arr, i) {
  var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr[
    "@@iterator"];
  if (null != _i) {
    var _s,
      _e,
...
function _objectSpread2(target) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object
      .getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) {
...
function _slicedToArray(arr, i) {
  return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr,
    i) || _nonIterableRest();
}
...
var AF_CUSTOM_EXCLUDE_PARAMS_KEYS = ['pid', 'c', 'af_channel', 'af_ad', 'af_adset',
  'deep_link_value', 'af_sub1', 'af_sub2', 'af_sub3', 'af_sub4', 'af_sub5'
];
...
var getParameterValue = function getParameterValue(currentURLParams) {
  ...
  if (!(config !== null && config !== void 0 && config.keys && Array.isArray(config.keys) ||
...
var isUACHSupported = function isUACHSupported() {
  return (typeof navigator === "undefined" ? "undefined" : _typeof(navigator)) === 'object' &&
    'userAgentData' in navigator && 'getHighEntropyValues' in navigator.userAgentData && !isIOS(
...
var removeExpiredLocalStorageItems = function removeExpiredLocalStorageItems() {
  var currentTime = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : Date
    .now();
  var incomingParams = JSON.parse(localStorage.getItem('ss_incoming_params') || '[]');
  localStorage.setItem('ss_incoming_params', JSON.stringify(incomingParams.filter(function (
    _ref4) {
...
var isOneLinkURLValid = function isOneLinkURLValid(oneLinkURL) {
  var _ref5;
  var oneLinkURLParts = (_ref5 = oneLinkURL || '') === null || _ref5 === void 0 ? void 0 : _ref5
    .toString().match(AF_URL_SCHEME);
  if (!oneLinkURLParts || (oneLinkURLParts === null || oneLinkURLParts === void 0 ? void 0 :
      oneLinkURLParts.length) < VALID_AF_URL_PARTS_LENGTH) {
    console.error("oneLinkURL is missing or not in the correct format, can't generate URL",
      oneLinkURL);
    return false;
  }
  return true;
...
var validatedMs = function validatedMs() {
  ...
  if ((mediaSource === null || mediaSource === void 0 ? void 0 : (_mediaSource$keys = mediaSource
      .keys) === null || _mediaSource$keys === void 0 ? void 0 : _mediaSource$keys.length) ===
    0 && !(mediaSource !== null && mediaSource !== void 0 && mediaSource.defaultValue)) {
    console.error("mediaSource is missing (default value was not supplied), can't generate URL",
      mediaSource);
    return false;
  }
  return true;
    ...
    afCustom.forEach(function (customParam) {
      if (customParam !== null && customParam !== void 0 && customParam.paramKey) {
        var isOverrideExistingKey = AF_CUSTOM_EXCLUDE_PARAMS_KEYS.find(function (k) {
          return k === (customParam === null || customParam === void 0 ? void 0 :
            customParam.paramKey);
        });
        if ((customParam === null || customParam === void 0 ? void 0 : customParam
            .paramKey) === googleClickIdKey || isOverrideExistingKey) {
          console.debug(
...
var validateAndMappedParams = function validateAndMappedParams() {
  ...
  if (googleClickIdKey) {
    if (GCLID_EXCLUDE_PARAMS_KEYS.find(function (k) {
      ...
      console.debug("Google Click Id ParamKey can't override AF Parameters keys",
        googleClickIdKey);
    } else {
...
var isPlatformValid = function isPlatformValid(platform) {
  ...
  var platforms = ['smartcast', 'tizen', 'roku', 'webos', 'vidaa', 'playstation', 'android',
    'ios', 'steam', 'quest', 'battlenet', 'epic', 'switch', 'xbox', 'nativepc'
  ];
...
function getUserAgentData() {
  return new Promise(function (resolve) {
    if (isUACHSupported()) {
      navigator.userAgentData.getHighEntropyValues(['model', 'platformVersion']).then(function (
        clientHints) {
        resolve({
  ...
  return new Promise(function (resolve) {
    getUserAgentData().then(function (userAgentData) {
      ...
      if (userAgentData) {
        ...
        url.searchParams.append('af_ch_os_version', encodeURIComponent(userAgentData
          .platformVersion));
      }
      resolve(url.href);
    })["catch"](function () {
...
function QRCode() {
  ...
  /** Node.js global æ£€æµ‹. */
  var freeGlobal = (typeof global === "undefined" ? "undefined" : _typeof(global)) == 'object' &&
    global && global.Object === Object && global;

  /** `self` å˜é‡æ£€æµ‹. */
  var freeSelf = (typeof self === "undefined" ? "undefined" : _typeof(self)) == 'object' && self &&
  ...
  /** `exports` å˜é‡æ£€æµ‹. */
  var freeExports = (typeof exports === "undefined" ? "undefined" : _typeof(exports)) == 'object' &&
    exports && !exports.nodeType && exports;

  /** `module` å˜é‡æ£€æµ‹. */
  var freeModule = freeExports && (typeof module === "undefined" ? "undefined" : _typeof(module)) ==
    'object' && module && !module.nodeType && module;
      ...
      for (var row = 0; row < moduleCount; row++) {
        for (var col = 0; col < moduleCount - 6; col++) {
          if (qrCode.isDark(row, col) && !qrCode.isDark(row, col + 1) && qrCode.isDark(row,
              col + 2) && qrCode.isDark(row, col + 3) && qrCode.isDark(row, col + 4) && !qrCode
  ...
  for (var i = 8; i < 256; i++) {
    QRMath.EXP_TABLE[i] = QRMath.EXP_TABLE[i - 4] ^ QRMath.EXP_TABLE[i - 5] ^ QRMath.EXP_TABLE[i -
    ...
    Drawing.prototype.draw = function (oQRCode) {
      ...
      if (_htOption.backgroundImage) {
        ...
        var backgroundImageEle =
          ...
          _htOption.backgroundImage + '" widht="' + (_htOption.width + _htOption.quietZone *
            2) + '" height="' + (_htOption.height + _htOption.quietZone * 2) +
          '" style="opacity:' + _htOption.backgroundImageAlpha + ';filter:alpha(opacity=' +
          _htOption.backgroundImageAlpha * 100 + '); "/></div>';
        aHTML.push(backgroundImageEle);
      }
      if (_htOption.quietZone) {
        divStyle = 'display:inline-block; width:' + (_htOption.width + _htOption.quietZone *
            2) + 'px; height:' + (_htOption.width + _htOption.quietZone * 2) +
          'px;background:' +
          _htOption.quietZoneColor + '; text-align:center;';
      }
      ...
      if (_htOption.title) {
        ...
        aHTML.push('<div style="width:100%;margin-top:' + _htOption.titleTop + 'px;color:' + c +
          ';font:' + f + ';background:' + _htOption.titleBackgroundColor + '">' + _htOption
          .title + '</div>');
      }
      if (_htOption.subTitle) {
        aHTML.push('<div style="width:100%;margin-top:' + (_htOption.subTitleTop - _htOption
            .titleTop) + 'px;color:' + _htOption.subTitleColor + '; font:' + _htOption
        ...
        for (var col = 0; col < nCount; col++) {
          ...
          if (eye) {
            ...
            aHTML.push(
              ...
              nWidth + 'px;height:' + nHeight + 'px;">' + '<span style="width:' + nWidth +
              'px;height:' + nHeight + 'px;background-color:' + (bIsDark ? eyeColorDark :
                nonRequiredcolorLight) + ';display:inline-block"></span></td>');
          } else {
            // Timing Pattern
            ...
            if (row == 6) {
              ...
              aHTML.push(
                '<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' +
                nWidth + 'px;height:' + nHeight + 'px;background-color:' + (bIsDark ?
                  nowDarkColor : nonRequiredcolorLight) + ';"></td>');
            } else if (col == 6) {
              ...
              aHTML.push(
                '<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' +
                nWidth + 'px;height:' + nHeight + 'px;">' +
                '<div style="display:inline-block;width:' + drawWidth + 'px;height:' +
                drawHeight + 'px;background-color:' + (bIsDark ? nowDarkColor : _htOption
                  .colorLight) + ';"></div></td>');
            }
          }
        }
      ...
      if (_htOption.logo) {
        ...
        var imgDivStyle = 'position:relative; z-index:1;display:table-cell;top:-' + ((_htOption
            .height - _htOption.titleHeight) / 2 + imgH / 2 + _htOption.quietZone) +
          'px;text-align:center; width:' + imgW + 'px; height:' + imgH + 'px;line-height:' +
          imgW + 'px; vertical-align: middle;';
    ...
    Drawing.prototype.draw = function (oQRCode) {
      ...
      if (_htOption.backgroundImage) {
        ...
        bgImg.onload = function () {
          ...
          _oContext.drawImage(bgImg, 0, _htOption.titleHeight, _htOption.width + _htOption
            .quietZone * 2, _htOption.height + _htOption.quietZone * 2 - _htOption
            .titleHeight);
      ...
      function drawQrcode(oQRCode) {
        ...
        for (var row = 0; row < nCount; row++) {
          for (var col = 0; col < nCount; col++) {
            ...
            var lColor;
            if (eye) {
              dColor = _htOption[eye.type] || _htOption[eye.type.substring(0, 2)] || _htOption
                .colorDark;
            ...
            if (eye) {
              ...
              if (_htOption.backgroundImage && _htOption.autoColor) {
                dColor = (eye.type == 'AO' ? _htOption.AI : _htOption.AO) || _htOption
                  .autoColorDark;
                lColor = _htOption.autoColorLight;
              } else {
              ...
              _oContext.fillRect(nLeft + nWidth * (1 - nowDotScale) / 2, _htOption.titleHeight +
                nTop + nHeight * (1 - nowDotScale) / 2, nWidth * nowDotScale, nHeight *
                nowDotScale);
            } else {
              if (row == 6) {
                // Timing Pattern
                ...
                _oContext.fillRect(nLeft + nWidth * (1 - nowDotScale) / 2, _htOption
                  .titleHeight + nTop + nHeight * (1 - nowDotScale) / 2, nWidth * nowDotScale,
                  nHeight * nowDotScale);
              } else if (col == 6) {
                // Timing Pattern
                ...
                if (_htOption.backgroundImage) {
                  _oContext.fillRect(nLeft + nWidth * (1 - nowDotScale) / 2, _htOption
                    .titleHeight + nTop + nHeight * (1 - nowDotScale) / 2, nWidth *
                    nowDotScale, nHeight * nowDotScale);
                } else {
                  _oContext.fillRect(nLeft + nWidth * (1 - nowDotScale) / 2, _htOption
                    .titleHeight + nTop + nHeight * (1 - nowDotScale) / 2, nWidth *
                    nowDotScale, nHeight * nowDotScale);
        ...
        if (_htOption.subTitle) {
          ...
          _oContext.fillText(_htOption.subTitle, this._elCanvas.width / 2, +_htOption
            .quietZone + _htOption.subTitleTop);
        }
        ...
        function generateLogoImg(img) {
          ...
          if (_htOption.logoMaxWidth || _htOption.logoMaxHeight) {
            ...
            imgContainerY = (_htOption.height + _htOption.titleHeight + _htOption.quietZone *
              2 - imgContainerH) / 2;
          }
  ...
  function _getTypeNumber(sText, _htOption) {
    ...
    if (_htOption.version != 0) {
      if (nType <= _htOption.version) {
        ...
        console.warn('QR Code version ' + _htOption.version + ' too small, run version use ' +
          nType);
        _htOption.runVersion = nType;
      }
    }
  ...
  QRCode = function QRCode(el, vOption) {
    ...
    if (!this._htOption.drawer || this._htOption.drawer != 'svg' && this._htOption.drawer !=
      'canvas') {
  ...
  QRCode.prototype.makeCode = function (sText) {
    this._oQRCode = new QRCodeModel(_getTypeNumber(sText, this._htOption), this._htOption
      .correctLevel);
...
(function () {
  var generateOneLinkURL = function generateOneLinkURL() {
    ...
    var webReferrerValue = JSON.parse(localStorage.getItem(LOCAL_STORAGE_VALUES
      .SS_WEB_REFERRER));
    ...
    window.AF_SMART_SCRIPT.displayQrCode = function (htmlId) {
      ...
      return new window.QRCode(document.getElementById(htmlId), {
        text: "".concat(finalURL, "&af_ss_qr=").concat(qrOptions.logo || qrOptions
          .codeColor ? 'c' : 'true', " "),
        logo: logo,
        colorDark: getHexColorAfterValidation(codeColor),
        logoBackgroundTransparent: true,
        crossOrigin: 'anonymous',
        correctLevel: logo ? window.QRCode.CorrectLevel.Q : window.QRCode.CorrectLevel.L
      });
    };
  ...
  var generateDirectClickURL = function generateDirectClickURL() {
    ...
    var lowerCasePlatform = platform === null || platform === void 0 ? void 0 : platform
      .toLowerCase();
    ...
    if ((campaign === null || campaign === void 0 ? void 0 : (_campaign$keys = campaign
        .keys) === null || _campaign$keys === void 0 ? void 0 : _campaign$keys.length) === 0 &&
      !(campaign !== null && campaign !== void 0 && campaign.defaultValue)) {
      console.error("campaign is missing (default value was not supplied), can't generate URL",
        mediaSource);
      return null;
    }
    if (!isSkipListsValid({
    ...
    var finalURL = "".concat(clickBaseUrl, "/").concat(app_id).concat(finalParams, "&af_r=")
      .concat(encodeURIComponent(redirectURL));
    if (['ios', 'android'].includes(lowerCasePlatform)) {
      finalURL = finalURL.replace('af_media_source', 'pid').replace('af_campaign', 'c').replace(
        'af_campaign_id', 'af_c_id');
    }
...
var oneLinkURL = "https://nagish.onelink.me/7Z9B";
var mediaSource = urlQueryParams.utm_source ? {
    keys: ["utm_source"],
    defaultValue: urlQueryParams
      .utm_source
  } :
  null;
var campaign = urlQueryParams.utm_campaign ? {
  keys: ["utm_campaign"],
  defaultValue: urlQueryParams.utm_campaign
} : null;
var channel = urlQueryParams.utm_medium ? { keys: ["utm_medium"], defaultValue: urlQueryParams
      .utm_medium } :
  null;
var ad = urlQueryParams.utm_adgroup ? { keys: ["utm_adgroup"], defaultValue: urlQueryParams
      .utm_adgroup } :
  null;
var deepLinkValue = urlQueryParams.utm_deeplink ? {
  keys: ["utm_deeplink"],
  defaultValue: urlQueryParams.utm_deeplink
} : null;
var af_dp = urlQueryParams.utm_uri ? {
  paramKey: "af_dp",
  keys: ["utm_uri"],
  defaultValue: urlQueryParams.utm_uri
} : null;
var af_term = urlQueryParams.utm_term ? {
  paramKey: "af_term",
  keys: ["utm_term"],
  defaultValue: urlQueryParams
    .utm_term
} : null;
var af_author = urlQueryParams.utm_author ? {
  paramKey: "af_author",
  keys: ["utm_author"],
  defaultValue: urlQueryParams.utm_author
} : null;
var af_platform = urlQueryParams.utm_platform ? {
  paramKey: "af_platform",
  keys: ["utm_platform"],
  defaultValue: urlQueryParams.utm_platform
} : null;
var custom_ss_ui = urlQueryParams.af_ss_ui ? { paramKey: "af_ss_ui", defaultValue: urlQueryParams
      .af_ss_ui } :
  null;

// Get the value of "some_key" in eg "https://example.com/?some_key=some_value"
var value = urlQueryParams.some_key; // "some_value"
...
//const divID = document.getElementById('my_qr_code_div_id');
let result_url = "#"
if (result) {
  ...
  const qrOptions = {
    logo: 'https://uploads-ssl.webflow.com/639ce4c7e9b474078b0faf43/6547f4cdf4d90d724e2a351b_favicon.png'
  }

  // Optionally - Create QR code from the generated OneLink URL
  if (document.getElementById('my_qr_code_div_id')) {
    window.AF_SMART_SCRIPT.displayQrCode("my_qr_code_div_id", qrOptions);
  }
